...
class SolicitudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitud" do
    assert_difference('Solicitud.count') do
      post solicituds_url, params: { solicitud: { ap: @solicitud.ap, direccion: @solicitud.direccion, edad: @solicitud.edad, email: @solicitud.email, nombre: @solicitud.nombre, programa: @solicitud.programa, telefono: @solicitud.telefono } }
    end
  ...
  test "should update solicitud" do
    patch solicitud_url(@solicitud), params: { solicitud: { ap: @solicitud.ap, direccion: @solicitud.direccion, edad: @solicitud.edad, email: @solicitud.email, nombre: @solicitud.nombre, programa: @solicitud.programa, telefono: @solicitud.telefono } }
